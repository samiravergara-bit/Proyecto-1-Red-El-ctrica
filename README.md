...
2. Feature Engineering: Para darle mejores pistas a los modelos crearé nuevas variables numéricas que capturen infromación para mejorar su capacidad predictiva. Algunas como la suma de la potencia demandada, el tiempo promedio de respuesta del sistema, la variabilidad en tiempos de respuesta, reacción promedio de carga y la amplitud de variación en reacción de cargas.
